  ...
  return (
    ...
    <div className="front-container">
      <div className="sub-front-container1">
        ...
        <p style={{fontWeight:"200",maxWidth:"20rem",fontSize:"1.2rem" ,color:'#2F4858', marginTop:'1.2rem'}}>Elevate your taste buds and your health with every bite</p>
        <div className='enter-btn'><Link to='/landing'><button className='sub-btn'>Get Started</button></Link></div>
      </div>
